Ext.define("app.view.baseequip.component.BaseequipSubGrid", {
    extend: 'app.ux.grid.BaseSubGrid',
    alias: 'widget.baseequipsubgrid',
    title : '详细数据',
    initComponent: function () {
        ...
        var uiserverinfos = app.ux.UiServer.getinfosfast("baseequipment");  //vosign
        ...
        me.model = app.ux.ModelFactory.getModelFast(uiserverinfos ,{
			...
			api : {
	            read: webContextValue  +  '/baseequip/reade/baseequipment',
