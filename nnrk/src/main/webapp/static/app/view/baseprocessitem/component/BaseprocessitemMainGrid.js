Ext.define("app.view.baseprocessitem.component.BaseprocessitemMainGrid", {
    extend: 'app.ux.grid.BaseMainGrid',
    alias: 'widget.baseprocessitemmaingrid',
    initComponent: function () {
        ...
        me.dockedItems = [{
        	...
        	items : [{
				...
				xtype : "textfield",fieldLabel : "参数名称",
				labelWidth : 70,width : 170,
				enableKeyEvents : true,
				queryparam : "params[like name]"
			},{
				xtype : "textfield",fieldLabel : "参数编码",
				labelWidth : 70,width : 170,
				enableKeyEvents : true,
