Ext.define("app.view.baseprocessparam.component.BaseprocessparamSubGrid", {
    extend: 'app.ux.grid.BaseSubGrid',
    alias: 'widget.baseprocessparamsubgrid',
    title : '详细数据',
    initComponent: function () {
        ...
        var uiserverinfos = app.ux.UiServer.getinfosfast("baseprocessparamentry");  //vosign
        ...
        me.model = app.ux.ModelFactory.getModelFast(uiserverinfos ,{
			...
			api : {
	            read: webContextValue  +  '/baseprocessparam/reade/baseprocessparamentry' ,
