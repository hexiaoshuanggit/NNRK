Ext.define("app.view.baserouteline.component.BaseroutelineMainGrid", {
    extend: 'app.ux.grid.BaseMainGrid',
    alias: 'widget.baseroutelinemaingrid',
    initComponent: function () {
        ...
        me.dockedItems = [{
        	...
        	items : [{
				...
				xtype : "textfield",fieldLabel : "版本",
				labelWidth : 30,width : 130,
				enableKeyEvents : true,
				queryparam : "params[like version]"
			}],
        	dock : 'top'
        },{
			xtype : 'pagingtoolbar',
