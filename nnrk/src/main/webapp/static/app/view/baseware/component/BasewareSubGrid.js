Ext.define("app.view.baseware.component.BasewareSubGrid", {
    extend: 'app.ux.grid.BaseSubGrid',
    alias: 'widget.basewaresubgrid',
    title : '详细数据',
    initComponent: function () {
        ...
        var uiserverinfos = app.ux.UiServer.getinfosfast("basewarelocation");  //vosign
        ...
        me.model = app.ux.ModelFactory.getModelFast(uiserverinfos ,{
			...
			api : {
	            read: webContextValue  +  '/baseware/reade/basewarelocation' ,
