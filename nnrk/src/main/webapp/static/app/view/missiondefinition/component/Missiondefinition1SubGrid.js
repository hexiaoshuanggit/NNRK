Ext.define("app.view.missiondefinition.component.Missiondefinition1SubGrid", {
    extend: 'app.ux.grid.BaseSubGrid',
    alias: 'widget.missiondefinition1subgrid',
    title : '详细数据',
    initComponent: function () {
        ...
        me.model = app.ux.ModelFactory.getModelFast(uiserverinfos ,{
			...
			api : {
	            read: webContextValue  +  '/missiondefinition/reade/missiondefinitionentry' ,
