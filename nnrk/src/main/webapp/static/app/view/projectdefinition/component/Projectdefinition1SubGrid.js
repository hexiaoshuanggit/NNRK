Ext.define("app.view.projectdefinition.component.Projectdefinition1SubGrid", {
    extend: 'app.ux.grid.BaseSubGrid',
    alias: 'widget.projectdefinition1subgrid',
    title : '详细数据',
    initComponent: function () {
        ...
        var uiserverinfos = app.ux.UiServer.getinfosfast("projectteam");  //vosign
        ...
        me.model = app.ux.ModelFactory.getModelFast(uiserverinfos ,{
			...
			api : {
	            read: webContextValue  +  '/projectdefinition/reade/projectteam' ,
