Ext.define("app.view.projectmission.component.Projectmission2SubGrid", {
    extend: 'app.ux.grid.BaseSubGrid',
    alias: 'widget.projectmission2subgrid',
    title : '详细数据',
    initComponent: function () {
        ...
        var uiserverinfos = app.ux.UiServer.getinfosfast("targetresult");  //vosign
        ...
        me.model = app.ux.ModelFactory.getModelFast(uiserverinfos ,{
			...
			api : {
	            read: webContextValue  +  '/projectmission/reade/targetresult' ,
