Ext.define("app.view.acttaskcandidate.component.ActtaskcandidateSubCommentGrid", {
    extend: 'app.ux.grid.BaseSubGrid',
    alias: 'widget.acttaskcandidatesubcommentgrid',
    title : '审核意见',
    initComponent: function () {
        ...
        me.model = app.ux.ModelFactory.getModelFast(uiserverinfos ,{
			...
			api : {
	            read: webContextValue  +  '/actusertask/reade/' ,
