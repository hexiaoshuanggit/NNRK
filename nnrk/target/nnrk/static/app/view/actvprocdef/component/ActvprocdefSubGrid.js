Ext.define("app.view.actvprocdef.component.ActvprocdefSubGrid", {
    extend: 'app.ux.grid.BaseSubGrid',
    alias: 'widget.actvprocdefsubgrid',
    title : '任务处理人设定',
    initComponent: function () {
        ...
        var uiserverinfos = app.ux.UiServer.getinfosfast("actprocdefassignee");  //vosign
        ...
        me.model = app.ux.ModelFactory.getModelFast(uiserverinfos ,{
        	modelMainId : 'procdefId',
			extraParams : {
				//"sortedCondition[createTime]" : "asc"
			},
			api : {
	            read: webContextValue  +  '/actvprocdef/reade/actprocdefassignee' ,
