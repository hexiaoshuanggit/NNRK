Ext.define("app.view.basebomop.component.BasebomopSubGrid", {
    extend: 'app.ux.grid.BaseSubGrid',
    alias: 'widget.basebomopsubgrid',
    title : '详细数据',
    initComponent: function () {
        ...
        var uiserverinfos = app.ux.UiServer.getinfosfast("basebomopentry");  //vosign
        ...
        me.model = app.ux.ModelFactory.getModelFast(uiserverinfos ,{
			...
			api : {
	            read: webContextValue  +  '/basebomop/reade/basebomopentry' ,
