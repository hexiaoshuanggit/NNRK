Ext.define("app.view.basechkmrloptpl.component.BasechkmrloptplSubGrid", {
    extend: 'app.ux.grid.BaseSubGrid',
    alias: 'widget.basechkmrloptplsubgrid',
    title : '详细数据',
    initComponent: function () {
        ...
        var uiserverinfos = app.ux.UiServer.getinfosfast("basechkmrloptplentry");  //vosign
        ...
        me.model = app.ux.ModelFactory.getModelFast(uiserverinfos ,{
			...
			api : {
	            read: webContextValue  +  '/basechkmrloptpl/reade/basechkmrloptplentry',
