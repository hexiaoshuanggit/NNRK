Ext.define("app.view.basechkmrlwhtpl.component.BasechkmrlwhtplSubGrid", {
    extend: 'app.ux.grid.BaseSubGrid',
    alias: 'widget.basechkmrlwhtplsubgrid',
    title : '详细数据',
    initComponent: function () {
        ...
        var uiserverinfos = app.ux.UiServer.getinfosfast("basechkmrlwhtplentry");  //vosign
        ...
        me.model = app.ux.ModelFactory.getModelFast(uiserverinfos ,{
			...
			api : {
	            read: webContextValue  +  '/basechkmrlwhtpl/reade/basechkmrlwhtplentry',
