Ext.define("app.view.baserouteline.component.BaseroutelineSubGrid2", {
    extend: 'app.ux.grid.BaseSubGrid',
    alias: 'widget.baseroutelinesubgrid2',
    title : '产品信息',
    initComponent: function () {
        ...
        var uiserverinfos = app.ux.UiServer.getinfosfast("baserouteproduct");  //vosign
...
//				"sortedCondition[1_opSeq]" : "asc"
			...
			api : {
	            read: webContextValue  +  '/baserouteline/reade/baserouteproduct' ,
