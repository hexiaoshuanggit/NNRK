...
@Table(name = "BASE_CHK_MRLWHTPL_ENTRY")
@JsonIgnoreProperties(value= {"chkMrlWhTpl"})
public class BaseChkMrlWhTplEntry extends BaseEntityD{
	...
	private BaseChkMrlWhTpl chkMrlWhTpl;
	...
	public BaseChkMrlWhTpl getChkMrlWhTpl() {
		return chkMrlWhTpl;
	}
	public void setChkMrlWhTpl(BaseChkMrlWhTpl chkMrlWhTpl) {
		this.chkMrlWhTpl = chkMrlWhTpl;
	}
