Ext.define('app.view.basechkmrloptpl.component.BasechkmrloptplOpenWin2', {
	extend : 'app.ux.window.PopUpWin',
	alias : 'widget.basechkmrloptplopenwin2',
	title : '选择',
	querybar : ['->',{
		xtype : 'textfield',
		fieldLabel : '物料编码',
	...
	selreccallback : function(records,pgrid,fieldrefs){
		...
		var rec = records[0];
		var mform = this.up("basechkmrloptplwindow").down("form");
