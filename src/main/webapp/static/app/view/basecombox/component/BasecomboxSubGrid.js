Ext.define("app.view.basecombox.component.BasecomboxSubGrid", {
    extend: 'app.ux.grid.BaseSubGrid',
    alias: 'widget.basecomboxsubgrid',
    title : '详细数据',
    initComponent: function () {
        ...
        var uiserverinfos = app.ux.UiServer.getinfosfast("basecomboxentry");  //vosign
        ...
        me.model = app.ux.ModelFactory.getModelFast(uiserverinfos ,{
			...
			api : {
	            read: webContextValue  +  '/basecombox/reade/basecomboxentry' ,
