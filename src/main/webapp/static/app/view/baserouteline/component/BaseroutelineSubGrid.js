Ext.define("app.view.baserouteline.component.BaseroutelineSubGrid", {
    extend: 'app.ux.grid.BaseSubGrid',
    alias: 'widget.baseroutelinesubgrid',
    title : '工序',
    initComponent: function () {
        ...
        var uiserverinfos = app.ux.UiServer.getinfosfast("baserouteoperation");  //vosign
        ...
        me.model = app.ux.ModelFactory.getModelFast(uiserverinfos ,{
        	modelMainId : 'mainId',
			extraParams : {
				"sortedCondition[1_opSeq]" : "asc"
			},
			api : {
	            read: webContextValue  +  '/baserouteline/reade/baserouteoperation' ,
