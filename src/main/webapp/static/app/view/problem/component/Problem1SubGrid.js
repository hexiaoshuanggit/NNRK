Ext.define("app.view.problem.component.Problem1SubGrid", {
    extend: 'app.ux.grid.BaseSubGrid',
    alias: 'widget.problem1subgrid',
    title : '详细数据',
    initComponent: function () {
        ...
        var uiserverinfos = app.ux.UiServer.getinfosfast("problementry");  //vosign
        ...
        me.model = app.ux.ModelFactory.getModelFast(uiserverinfos ,{
			...
			api : {
	            read: webContextValue  +  '/problem/reade/problementry' ,
