Ext.define("app.view.project.component.Project1SubGrid", {
    extend: 'app.ux.grid.BaseSubGrid',
    alias: 'widget.project1subgrid',
    title : '详细数据',
    initComponent: function () {
        ...
        me.model = app.ux.ModelFactory.getModelFast(uiserverinfos ,{
			...
			api : {
	            read: webContextValue  +  '/project/reade/projectmission' ,
