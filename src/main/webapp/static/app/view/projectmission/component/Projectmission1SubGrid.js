Ext.define("app.view.projectmission.component.Projectmission1SubGrid", {
    extend: 'app.ux.grid.BaseSubGrid',
    alias: 'widget.projectmission1subgrid',
    title : '详细数据',
    initComponent: function () {
        ...
        var uiserverinfos = app.ux.UiServer.getinfosfast("projecttarget");  //vosign
        ...
        me.model = app.ux.ModelFactory.getModelFast(uiserverinfos ,{
			...
			api : {
	            read: webContextValue  +  '/projectmission/reade/projecttarget' ,
